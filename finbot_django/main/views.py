    ...
    if request.method == 'POST':
        ...
        if dateform.is_valid():
            ...
            if filtered_by_dates:
                aggregated_cat_amount = Transaction.items.aggregate_cat_amount(
                    start_date, end_date)
                ...
                aggregated_payment_method_amount = Transaction.items.\
                    aggregate_payment_method_amount(start_date, end_date)
